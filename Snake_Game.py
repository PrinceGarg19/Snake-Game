...
main_sound = pygame.mixer.Sound("music.wav")
button_sound = pygame.mixer.Sound("Button.wav")
end_sound = pygame.mixer.Sound("Game_over.wav")
...
# fonts
score_f = pygame.font.Font(r"font_1.ttf",40)
score_main_f = pygame.font.SysFont(None,30)
button_f = pygame.font.Font(r"font_3.ttf",30)
Big = pygame.font.Font(r"font_2.ttf",int(80*screen_height*screen_width/540000))
...
#game variables....
    ...
    image_food = pygame.image.load(r"food.jpg")
    ...
    while not exit_game:
        ...
        # snake length increament code......
            ...
            if len(snake_list)>snake_length:
                del snake_list[0]
    # collision code.....
            if snake_x <= l or snake_x >= screen_width-l or snake_y <= l  or snake_y >= screen_height-l:
                velocity_x = 0
                velocity_y = 0 
                game_over = True
